...
class _UserHomePageState extends State<UserHomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // fetch a short affirmation when the view initializes
    try {
      final c = HomeUserHomeController();
      c.fetchMotivation().then((_) {
        if (mounted) setState(() {});
      });
      _userMotivationController = c;
    } catch (_) {}
  }
  ...
  late HomeUserHomeController? _userMotivationController;
                    ...
                    AnimatedContainer(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          // show fetched affirmation (if available)
                          if ((_userMotivationController?.motivation.value ?? '').isNotEmpty)
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  const SizedBox(width: 8),
                                  Expanded(child: Text(_userMotivationController!.motivation.value, style: const TextStyle(fontSize: 14))),
                                ],
                              ),
                            ),
                          const SizedBox(height: 12),
